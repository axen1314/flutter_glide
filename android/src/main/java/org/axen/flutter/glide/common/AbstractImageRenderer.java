...
public abstract class AbstractImageRenderer<T> implements ImageRenderer<T> {
    ...
    public void render(final GlideImage info, final MethodChannel.Result result) {
    ...
    protected abstract void onDraw(T image, GlideImage info, MethodChannel.Result result);
